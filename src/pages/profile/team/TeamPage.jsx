...
export const TeamPage = () => {
    ...
    const [teamMembers, setTeamMembers] = useState(['name1', 'name2', 'name3', 'name4']);
    ...
    return (
        <div className={styles.userpage}>
            ...
            {showEdit && (<div className={styles.teamform}>
                ...
                Team Name: <input type="text" onChange={handleSetTeamName} />
                name: <input type="text" onChange={handleSetMemberName1} />
                name: <input type="text" onChange={handleSetMemberName2} />
                name: <input type="text" onChange={handleSetMemberName3} />
                name: <input type="text" onChange={handleSetMemberName4} />
            ...
            {!showEdit && (<div className={styles.teamform}>
                ...
                <button onClick={handleShowEdit} >Edit Team</button>
            </div>
            )}
